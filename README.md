...
# Get grasps
Run the command below and you will get npy and txt file that store the grasps generated by 6dof-graspnet.
```shell
python demo/get_grasps.py --grasp_sampler_folder checkpoints/vae_pretrained/ --refinement_method gradient --pc_path demo/data/pco.npy --npy_save_path demo/data/grasps.npy --txt_save_path demo/data/grasps.txt
```
To obtain object point cloud data in simulation environment, you can use <https://github.com/rhett-chen/airobot>
